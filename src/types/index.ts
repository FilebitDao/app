...
export enum FilChainId {
  MAINNET = parseInt(process.env.REACT_APP_CHAIN_ID),
  TESTNET = parseInt(process.env.REACT_APP_CHAIN_ID)
}
...
export interface Asset {
  ...
  borrowApy: BigNumber
  nwlBorrowApy: BigNumber
  nwlBorrowApr: BigNumber
  borrowCaps: BigNumber
  liquidity: BigNumber
  nwlSupplyApy: BigNumber
  nwlSupplyApr: BigNumber
  supplyApy: BigNumber
...
export interface NToken extends Omit<Token, 'isNative'> {
  decimals: 8 // NBep tokens all have 8 decimals
...
export interface Market {
  ...
  borrowNarwhalApy: BigNumber
  borrowNarwhalApr: BigNumber
  borrowerCount: number
  borrowerDailyNarwhal: string
  cash: string
  ...
  supplierDailyNarwhal: string
  supplyApy: BigNumber
  supplyRatePerBlock: string
  supplyNarwhalApy: BigNumber
  supplyNarwhalApr: BigNumber
  symbol: string
  tokenPrice: BigNumber
  totalBorrows: string
...
export interface MarketSnapshot {
  ...
  blockTimestamp: number
  borrowApy: string
  borrowNarwhalApy: string
  createdAt: string
  exchangeRate: string
  id: string
  priceUSD: string
  supplyApy: string
  supplyNarwhalApy: string
  totalBorrow: string
  totalSupply: string
  updatedAt: string
}
