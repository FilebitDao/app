...
export type MintBehalf = ContractEventLog<{
  payer: string;
  receiver: string;
  mintAmount: string;
  mintTokens: string;
...
export type RedeemFee = ContractEventLog<{
  redeemer: string;
  feeAmount: string;
  redeemTokens: string;
  0: string;
...
export interface NFilToken extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  events: {
    ...
    MintBehalf(cb?: Callback<MintBehalf>): EventEmitter;
    MintBehalf(options?: EventOptions, cb?: Callback<MintBehalf>): EventEmitter;
    ...
    RedeemFee(cb?: Callback<RedeemFee>): EventEmitter;
    RedeemFee(options?: EventOptions, cb?: Callback<RedeemFee>): EventEmitter;
  ...
  once(event: "MintBehalf", cb: Callback<MintBehalf>): void;
  once(
    event: "MintBehalf",
    options: EventOptions,
    cb: Callback<MintBehalf>
  ): void;
  ...
  once(event: "RedeemFee", cb: Callback<RedeemFee>): void;
  once(
    event: "RedeemFee",
    options: EventOptions,
    cb: Callback<RedeemFee>
  ): void;
