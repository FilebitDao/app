...
export enum NaiControllerErrorReporterError {
  NO_ERROR,
  UNAUTHORIZED,
  REJECTION,
  SNAPSHOT_ERROR,
...
export enum NaiControllerErrorReporterFailureInfo {
  SET_PENDING_ADMIN_OWNER_CHECK,
  SET_PENDING_IMPLEMENTATION_OWNER_CHECK,
  SET_COMPTROLLER_OWNER_CHECK,
  ACCEPT_ADMIN_PENDING_ADMIN_CHECK,
...
export enum NaiVaultErrorReporterError {
  NO_ERROR,
  UNAUTHORIZED
}

export enum NaiVaultErrorReporterInfo {
  ACCEPT_ADMIN_PENDING_ADMIN_CHECK,
  ACCEPT_PENDING_IMPLEMENTATION_ADDRESS_CHECK,
  SET_PENDING_ADMIN_OWNER_CHECK,
  SET_PENDING_IMPLEMENTATION_OWNER_CHECK
...
export enum NwlVaultProxyErrorReporterError {
  NO_ERROR,
  UNAUTHORIZED
}

export enum NwlVaultProxyErrorReporterInfo {
  ACCEPT_ADMIN_PENDING_ADMIN_CHECK,
  ACCEPT_PENDING_IMPLEMENTATION_ADDRESS_CHECK,
  SET_PENDING_ADMIN_OWNER_CHECK,
  SET_PENDING_IMPLEMENTATION_OWNER_CHECK
